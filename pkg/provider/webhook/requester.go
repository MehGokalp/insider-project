...
type Requester interface {
	SendSMS(request SendMessageRequest) (*SendMessageResponse, error)
}
...
func NewRequester(client HTTPClient, baseUri string, logger pkgLog.Logger, validator *validator.Validate) *HttpRequester {
...
func (r *HttpRequester) SendSMS(request SendMessageRequest) (*SendMessageResponse, error) {
	// validate request
